...
This environment requires both **TensorFlow/Keras** (for DOSMA segmentation models) and **nnU-Net** (for alternative segmentation). These packages have conflicting NumPy version requirements:
